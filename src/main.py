...
v, p = operational_strategy['v'], operational_strategy['p']
w, P = operational_strategy['w'], operational_strategy['P']
T = operational_strategy['T']
...
# Plot the curves
plot_power_and_thrust_curves(wind_speed_range, power_curve, 
                             thrust_curve, path_operational_strategy)
